...
ui_interface_string_t* ui_default_Static_WUST_RM = &ui_default_Static_4.option;
...
void _ui_init_default_Static_4() {
    ...
    ui_default_Static_4.option.font_size = 40;
    ui_default_Static_4.option.start_x = 1592;
    ui_default_Static_4.option.start_y = 517 - 80;
    ui_default_Static_4.option.color = 8;
    ui_default_Static_4.option.str_length = 7;
    ui_default_Static_4.option.width = 4;
